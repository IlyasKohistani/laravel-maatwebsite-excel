        ...
        <div class="container">
            <div id="wizard" class="invisible">
                ...
                <section>
                    ...
                    <div class="form-group purpose-radios-wrapper">
                        <div class="input-group input-group-lg">
                            <select id="shops_selection" class="form-control select2">
                ...
                <section>
                    ...
                    <div class="form-group purpose-radios-wrapper">
                        <div class="input-group input-group-lg">
                            <select id="product_selection" class="form-control select2">
                ...
                <section>
                    ...
                    <div class="form-group purpose-radios-wrapper">
                        ...
                        <div class="input-group input-group-lg">
                            <select id="package_selection" class="form-control select2">
            ...
            <div class="wizard vertical">
                <table class="table table-bordered mt-5" id="table_shop_details" @if (count($shop_packages) == 0) style="visibility: hidden" @endif>
                    @if (count($shops) > 0)
                        <thead>
                            <tr>
                                <th colspan="3" id="table_shop_details_name" class="text-center">{{ $shops[0]->name }}
                                    <a href="{{ route('export.shop_details', ['shop_id' => $shops[0]->id]) }}"
                                        class="float-right text-success" data-toggle="tooltip" data-placement="top"
                                        title="Download Detailed Excel File"><i
                                            class="bi bi-file-earmark-excel-fill"></i></a></th>
                            </tr>
                            <tr>
                                <th>Products</th>
                                <th>Packages</th>
...
@section('script')
    <script>
        config.packages = [];
        @if (count($packages) == 0)
            config.func.packageBox.show('No package is available.');
        @else
